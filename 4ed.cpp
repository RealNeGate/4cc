...
App_Step_Sig(app_step){
    ...
    // NOTE(yasser): DPI changes
    float new_scale = system_get_screen_scale_factor();
    if (models->font_set.scale_factor != new_scale) {
        font_update_scale(&models->font_set, new_scale);
    }
